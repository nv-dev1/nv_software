                        ...
                        <div class="row"> 
                            ...
                            <div class="">
                                <div id='add_item_form' class="col-md-12   bg-light-blue-gradient">
                                    ...
                                    <h4 class="">Add Articles for Invoice</h4> 
                                    <div class="row col-md-12 col-md-offset-1 ">
                                        ...
                                        <div class="col-md-2 ">
                                            <div class="form-group pad">
                                                ...
                                                <?php  echo form_input('description',set_value('description'),' class="form-control add_item_inpt" data-live-search="true" id="description"');?>
                                            </div>
                                        </div>
                                    ...
                                    <table id="invoice_list_tbl" class="table table-bordered table-striped">
                                        <thead>
                                           <tr> 
                                               ...
                                               <th width="10%" style="text-align: right;">Unit Cost/g</th>  
