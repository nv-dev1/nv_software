             ...
             <?php echo form_open_multipart($this->router->fetch_class()."/validate"); ?> 
                    ...
                    <div class="box-body fl_scroll">
                        ...
                        <div class="row"> 
                                         ...
                                         <h5>Craftman Information</h5>
                                         <hr> 
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Craftman Name<span style="color: red">*</span></label>
                                                <div class="col-md-9">    
                                                    <?php echo form_input('craftman_name', set_value('craftman_name',$result['craftman_name']), 'id="craftman_name" class="form-control" placeholder="Enter Craftman Name"'.$dis.' '.$o_dis.' '); ?>
                                                   <?php echo form_error('craftman_name');?>&nbsp;
                                                </div> 
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">    
                                                     <?php echo form_input('craftman_short_name', set_value('craftman_short_name',$result['craftman_short_name']), 'id="craftman_short_name" class="form-control" placeholder="Enter short name"'.$dis.' '.$o_dis.' '); ?>
                                                   <?php echo form_error('craftman_short_name');?>&nbsp;
                                                </div> 
                                            </div>  
