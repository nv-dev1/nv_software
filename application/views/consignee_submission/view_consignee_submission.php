              ...
              <div class="box box-primary"> 
               ...
               <div class="row header_form_sales"> 
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Consignee Submission # <span style="color: red"></span></label>
                                    <div class="col-md-9">    
                                         <?php  echo form_input('cs_no',set_value('cs_no',$cs_data['cs_no']),' class="form-control " readonly id="cs_no"');?>
                            ...
                            <div class="col-md-4"> 
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">    
                                         <?php  echo form_dropdown('sales_type_id',$sales_type_list,set_value('sales_type_id',$cs_data['sales_type_id']),' class="form-control select2" data-live-search="true" id="sales_type_id"');?>
                                         <!--<span class="help-block"><?php // echo form_error('customer_type_id');?>&nbsp;</span>-->
                                    </div> 
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">    
                                         <?php  echo form_input('submitted_date',set_value('submitted_date',date('m/d/Y',$cs_data['submitted_date'])),' class="form-control datepicker" readonly id="submitted_date"');?>
                                         <!--<span class="help-block"><?php // echo form_error('submitted_date');?>&nbsp;</span>-->
                                    </div> 
                                </div>
                            </div>
                         ...
                         echo '<table width="100%" id="example1" class="table-line" border="0">
                                    <thead>
                                        <tr class="colored_bg" style="background-color:#E0E0E0;">
                                             <th colspan="6">'.$cs_desc_data['item_cats'][$inv_itms[0]['item_category']].'</th> 
                                         </tr>
                                        <tr style="">
