...
//    });
	...
	function get_results(){
        ...
        $.ajax({
			url: "<?php echo site_url('Consignee_submission/search');?>",
			type: 'post',
                        ...
                        <div class="row"> 
                            <div class="col-md-6"> 
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">CS No:<span style="color: red">*</span></label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <?php echo form_input('cs_no', set_value('cs_no'), 'id="cs_no" class="form-control" placeholder="Search by Invoice Number"'); ?>

                                            </div>                                            
                                            <span class="help-block"><?php echo form_error('cs_no');?></span>
                                        </div>
                                    </div> 
                            </div>
<!--                             <div class="col-md-6">
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">Consignee Sumissions Search Result</h3>
            </div>
            <!-- /.box-header -->
