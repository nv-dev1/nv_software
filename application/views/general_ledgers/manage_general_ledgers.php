        ...
        <div class="">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php echo $action;?> Ledger</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                        ...
                        <div class="row"> 
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Ledger Account<span style="color: red">*</span></label>
                                                    <div class="col-md-9">    
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Account Code<span style="color: red">*</span></label>
                                                    <div class="col-md-9">    
                                                        <?php echo form_input('account_code', set_value('account_code', $result['account_code']), 'id="account_code" class="form-control" placeholder="Eg Code"'.$dis.' '.$o_dis.' '); ?>
                                                        <span class="help-block"><?php echo form_error('account_code');?>&nbsp;</span>
                                                    </div> 
                                                </div> 
                                            </div> 
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">    
                                                       <?php  echo form_dropdown('account_type_id',$gl_acc_type_list,set_value('account_type_id',$result['account_type_id']),' class="form-control select2" data-live-search="true" id="account_type_id" '.$o_dis.'');?> 
                                                        <span class="help-block"><?php echo form_error('account_type_id');?>&nbsp;</span>
                                                    </div> 
                                                </div>
                                            </div>
