...
//                                    echo ($this->user_default_model->check_authority($this->session->userdata(SYSTEM_CODE)['user_role_ID'], $this->router->class, 'delete'))?'<a href="'. base_url('Sales_invoices/add/?soid='.$search['id']).'" title="Send to delivery" class="btn btn-default btn-xs"><span class="fa fa-truck"></span></a> ':'';
