...
<!--    
 ...
 <!--<br><hr>-->
    <section  class="content"> 
        ...
        <div class='alert alert-danger ' id="ogmsg2">
        <a class="close" data-dismiss="alert" href="#">&times;</a>
        <i ></i>&nbsp;<?php echo $this->session->flashdata('error'); ?>
        <script>jQuery(document).ready(function(){jQuery('#ogmsg2').delay(1500).slideUp(1000);});</script>
        </div>
        <?php } ?>

        <?php  if($this->session->flashdata('warn') != ''){ ?>
        <div class='alert alert-success ' id="ogmsg2">
        <a class="close" data-dismiss="alert" href="#">&times;</a>
...
//                                $("#og_search_result_1").html(result);
    //                            return false;
                                ...
                                var div_str = '<div class="col-md-2">'+
                                                        '<div class="form-group pad">'+
                                                            '<label for="og_item_quantity">Quantity <span id="og_unit_abbr">[Each]<span></label>'+
                                ...
                                if(res1.item_uom_id_2!=0){
                                        div_str = div_str + '<div class="col-md-2">'+
                                                                '<div class="form-group pad">'+
                                                                    '<label for="og_item_quantity_2">Quantity <span id="og_unit_abbr_2">[Each]<span></label>'+
...
//            $('#new_customer_name').focus();
    ...
    function add_og_modal(){
        ...
        var post_data = $('#og_form_div').find('select, textarea, input').serializeArray(); 
            ...
            post_data.push({name:"order_id",value:$('input[name=id]').val()}); 
...
//                    console.log(result_og);return  false;
                    var og_data = JSON.parse(result_og);
                    
                    var strg_og_row = '<tr>'+
                                         '<td colspan="9"></td>'+
                                         '<td  style="text-align: right;">Old Gold - ['+og_data.og_no+']</td>'+
                                         '<td  style="text-align: right;"><input hidden value="'+og_data.og_total+'" class="calc_amount og_amount_txt" name="og['+og_data.og_id+'][amount]">'+
                                                                         '<input hidden value="'+og_data.og_id+'" name="og['+og_data.og_id+'][og_id]">'+
                                                                         '<input hidden value="'+og_data.og_no+'" name="og['+og_data.og_id+'][og_no]"><span id="og_amount_td">'+(og_data.og_total).toFixed(2)+'</span></td>'+
                                         '<td  style="text-align: left;"><span style="color:red;cursor: pointer;" alt="Remove Old Gold" class="hide og_del_btn_'+og_data.og_id+'">X</span></td>'+
                                    '</tr>';
                            
                    $("#og_tfoot").append(strg_og_row);
                    calc_tots_og();
                    
                    $('.og_del_btn_'+og_data.og_id).click(function(){
