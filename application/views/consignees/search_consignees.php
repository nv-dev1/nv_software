...
$(document).ready(function(){  
	...
	function get_results(){
        $.ajax({
			url: "<?php echo site_url('Consignees/search');?>",
			type: 'post',
 ...
 <br><hr>
                            ...
                            <div class="col-md-6"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-search"></span></span>
                                                <?php echo form_input('phone', set_value('phone'), 'id="phone" class="form-control" placeholder="Search by Contact No."'); ?>
                            ...
                            <div class="col-md-6">  
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-search"></span></span>
                                                <?php echo form_input('code', set_value('code'), 'id="code" class="form-control" placeholder="Search by Consignee Code."'); ?>
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">Consignee List</h3>
            </div>
            <!-- /.box-header -->
