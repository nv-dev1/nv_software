...
$(document).ready(function(){  
	...
	function get_results(){
        $.ajax({
			url: "<?php echo site_url('Inventory_location/search');?>",
			type: 'post',
                        ...
                        <div class="row"> 
                            <div class="col-md-6"> 
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Location Name<span style="color: red"></span></label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-search"></span></span>
                                                <?php echo form_input('location_name', set_value('location_name'), 'id="location_name" class="form-control" placeholder="Search by Location Name"'); ?>
                            ...
                            <div class="col-md-6"> 
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Location Code<span style="color: red"></span></label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-search"></span></span>
                                                <?php echo form_input('code', set_value('code'), 'id="code" class="form-control" placeholder="Search by Location Code"'); ?>
