 ...
 <br><hr>
    <section  class="content"> 
        ...
        <div class="">
            ...
            <?php echo form_open("Purchasing_returns/validate", 'id="form_search" class="form-horizontal"')?>  
               ...
               <div class="row header_form_sales"> 
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">    
                                         <?php  echo form_input('supplier_invoice_no',set_value('supplier_invoice_no',$inv_dets['cn_no']),' class="form-control " readonly id="supplier_invoice_no"');?>
