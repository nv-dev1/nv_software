...
//    });
	...
	function get_results(){
        ...
        $.ajax({
			url: "<?php echo site_url('Purchasing_returns/search');?>",
			type: 'post',
                        ...
                        <div class="row"> 
                            <div class="col-md-6"> 
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Credit Note No:<span style="color: red">*</span></label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <?php echo form_input('cn_no', set_value('cn_no'), 'id="cn_no" class="form-control" placeholder="Search by Invoice Number"'); ?>

                                            </div>                                            
                                            <span class="help-block"><?php echo form_error('cn_no');?></span>
                                        </div>
                                    </div> 
                            </div>
<!--                             <div class="col-md-6">
