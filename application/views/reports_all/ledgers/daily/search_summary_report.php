...
//        var json_data = JSON.stringify(post_data)
	...
	function get_results(){
        ...
        post_data.push({name:"function_name",value:'search_ledger_day'});
                            ...
                            <div class="row col-md-12 col-md-offset-3">  
                                        ...
                                        <div class="col-md-3">  
                                                <div class="form-group pad">
                                                    <label for="date_day">Month</label>
                                                    <?php  echo form_input('date_day',set_value('date_day',date('F Y')),' class="form-control datepicker" readonly  id="date_day"');?>
                                                </div> 
                                        </div>    
                                        <div class="col-md-3">  
                                                <div class="form-group pad">
