...
//    });
	...
	function get_results(){
        ...
        $.ajax({
			url: "<?php echo site_url('Sales_orders/search');?>",
			type: 'post',
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                ...
                                                <?php echo form_input('order_no', set_value('order_no'), 'id="order_no" class="form-control" placeholder="Search by Invoice Number"'); ?>

                                            </div>                                            
                                            <span class="help-block"><?php echo form_error('order_no');?></span>
                                        </div>
                                    </div> 
                            </div>
<!--                             <div class="col-md-6">
