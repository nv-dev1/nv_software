...
//            echo '<pre>';        print_r($res_page_count); die;
            ...
            echo '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <div id="'.$search['id'].'"  class="thumbnail itm_click">
                          <a > <img class="toResizeClass" src="'. base_url(ITEM_IMAGES.(($search['image']!="")?$search['id'].'/'.$search['image']:'default.jpg')).'" alt="'.$search['item_name'].'" style="width:100% ;overflow: hidden"></a>
  ...
  <div class="modal-dialog " role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Item Info</h5>
...
//        console.log(itm_data)
        ...
        $('#modal_price').val(parseFloat((itm_data.item_price_amount==null)?0:itm_data.item_price_amount).toFixed(2));
