...
<div class="col-md-12">
    ...
    <!--Flash Error Msg-->
        ...
        <div class="">
            ...
            <?php echo ($this->user_default_model->check_authority($this->session->userdata(SYSTEM_CODE)['user_role_ID'], 'Payments', 'add'))?'<a href="'.base_url('Payments/add/20').'" class="btn btn-app "><i class="fa fa-money"></i>Payments</a>':''; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                ...
                                                <?php echo form_input('supp_invoice_no', set_value('supp_invoice_no'), 'id="supp_invoice_no" class="form-control" placeholder="Search by Invoice Number"'); ?>
...
<!--                             <div class="col-md-6">
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">Purchasing Invoice List</h3>
            </div>
            <!-- /.box-header -->
