               ...
               <div class="row header_form_sales"> 
                    ...
                    foreach ($inv_desc as $inv_itms){ 
                         echo '<table width="100%" id="example1" class="table-line" border="0">
                                    <thead>
                                        ...
                                        <tr style="">
                                             ...
                                             <th width="40%" style="text-align: left;"><u><b>Item Code</b></u></th>  
                     ...
                     foreach ($inv_itms as $inv_itm){
                         echo     '<tr>
                                        <td width="10%">'.$inv_itm['purchasing_unit'].'</td> 
                                        <td width="40%" style="text-align: left;">'.$inv_itm['item_code'].'</td>  
                                        <td width="40%" style="text-align: left;">'.$inv_itm['supplier_item_desc'].'</td>  
