...
//    });
	...
	function get_results(){
        ...
        $.ajax({
			url: "<?php echo site_url('Buy_gold/search');?>",
			type: 'post',
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                ...
                                                <?php echo form_input('og_no', set_value('og_no'), 'id="og_no" class="form-control" placeholder="Search by Invoice Number"'); ?>

                                            </div>                                            
                                            <span class="help-block"><?php echo form_error('og_no');?></span>
                                        </div>
                                    </div> 
                            </div>
<!--                             <div class="col-md-6">
