...
$(document).ready(function(){  
    ...
    $("#quick_entry_account_id").change(function(){
		event.preventDefault();
		get_results();
    });
...
//    });
	...
	function get_results(){
        ...
        $.ajax({
			url: "<?php echo site_url('Quick_entries/search');?>",
			type: 'post',
                                           ...
                                           <div class="col-md-9">                                            
                                               <div class="input-group">
                                                   <span class="input-group-addon"><span class="fa fa-search"></span></span>
                                                    <?php echo form_dropdown('quick_entry_account_id',$quick_entry_acc_list,set_value('quick_entry_account_id'),' class="form-control select2" id="quick_entry_account_id"');?>
                                               </div>                                             
                                           </div>
                                       </div>  
                        </div>
