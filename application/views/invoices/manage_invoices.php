            ...
            <?php echo form_open("Invoices/validate", 'id="form_search" class="form-horizontal"')?>  
                    ...
                    <div class="box-body">
                        ...
                        <div class="row"> 
                            <hr>
                            <div class="">
                                <div id='add_item_form' class="col-md-12 fl_scrollable_x">
                                    ...
                                    <table id="example1" class="table bg-gray-light table-bordered table-striped">
                                        <thead>
                                           <tr>
                                               ...
                                               <td><label for="item_desc">Item Description</label></td>
                                               <td><label for="item_quantity">Quantity</label></td>
                                               <td><label for="item_unit_cost">Unit Cost</label></td>
                                               <td><label for="item_discount">Discount</label></td>
