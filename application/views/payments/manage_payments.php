 ...
 <br><hr>
    <section  class="content"> 
        <div class="">
             ...
             <?php echo form_open_multipart("Payments/validate",'id="form_search" class="form-horizontal"'); ?> 
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">    
                                                <input type="number" name="transection_amount" min="0" id="transection_amount" value="<?php echo set_value('transection_amount',$result['transection_amount']);?>" class="form-control">
...
//            return false;
    ...
    function get_due_list(){
        ...
        $.ajax({
                url: "<?php echo site_url('Payments/fl_ajax');?>",
                type: 'post',
                data : post_data,
...
//                                fl_alert('info',rowCount)
                                $(res2).each(function (index, elment) {
                                    ...
                                    var newRow = '<tr>'+
                                                        ...
                                                        '<td align="center">'+elment.invoice_dets.invoice_no+'<input hidden name="allocation['+elment.invoice_dets.id+'][inv_no]" value="'+elment.invoice_dets.invoice_no+'"></td>'+ 
                                                        '<td align="center">'+trans_date+'</td>'+
                                                        '<td align="center">'+timeConverter(due_date)+'</td>'+ 
                                                        '<td align="right">'+addCommas(parseFloat(elment.invoice_desc_total).toFixed(2))+'</td>'+
                                                        '<td align="right">'+addCommas(parseFloat(Math.abs(elment.transection_total)).toFixed(2))+'</td>'+
                                                        '<td align="right">'+addCommas(parseFloat(elment.invoice_total).toFixed(2))+'<input hidden name="allocation['+elment.invoice_dets.id+'][amount_due]"  id="amount_due_'+elment.invoice_dets.id+'" value="'+elment.invoice_total+'"></td>'+
