...
//    });
	...
	function get_results(){
        ...
        $.ajax({
			url: "<?php echo site_url('Sales_invoices/search');?>",
			type: 'post',
...
<div class="col-md-12">
    ...
    <!--Flash Error Msg-->
        ...
        <div class="">
            ...
            <?php echo ($this->user_default_model->check_authority($this->session->userdata(SYSTEM_CODE)['user_role_ID'], 'Payments', 'add'))?'<a href="'.base_url('Payments/add/10').'" class="btn btn-app "><i class="fa fa-money"></i>Payments</a>':''; ?>
