...
//    });
	...
	function get_results(){
        ...
        $.ajax({
			url: "<?php echo site_url('Consignee_receive/search');?>",
			type: 'post',
                        ...
                        <div class="row"> 
                            <div class="col-md-6"> 
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Cons. Receive Note No:<span style="color: red">*</span></label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <?php echo form_input('cr_no', set_value('cr_no'), 'id="cr_no" class="form-control" placeholder="Search by Invoice Number"'); ?>

                                            </div>                                            
                                            <span class="help-block"><?php echo form_error('cr_no');?></span>
                                        </div>
                                    </div> 
                            </div>
<!--                             <div class="col-md-6">
                                           ...
                                           <div class="col-md-9">                                            
                                               <div class="input-group">
                                                   <span class="input-group-addon"><span class="fa fa-search"></span></span>
                                                    <?php echo form_dropdown('consignee_id',$customer_list,set_value('consignee_id'),' class="form-control select2" id="consignee_id"');?>
                                               </div>                                             
                                           </div>
                                       </div> 
                                </div> 
