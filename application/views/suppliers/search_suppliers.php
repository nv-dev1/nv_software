...
//    });
	...
	function get_results(){
        $.ajax({
			url: "<?php echo site_url('Suppliers/search');?>",
			type: 'post',
 ...
 <br><hr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                ...
                                                <?php echo form_input('name', set_value('name'), 'id="name" class="form-control" placeholder="Search by Supplier Name"'); ?>
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">Supplier list with advanced search Features</h3>
            </div>
            <!-- /.box-header -->
