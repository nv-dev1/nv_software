<?php
	...
	$result = array(
                        'id'=>"",
                        'begin'=>strtotime('+1 Day',$active_fiscal_year['end']),
                        'end'=> strtotime('+1 Year',$active_fiscal_year['end']),
                        'closed'=>"0",
                        'status'=>"0"
                        );   		
                                            ...
                                            <div class="col-md-6"> 
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 input-group">    
                                                        ...
                                                        <?php echo form_input('begin', set_value('begin', date(SYS_DATE_FORMAT,$result['begin'])), 'id="begin" readonly class="form-control datepicker" placeholder="Enter Fiscal Year Begining Date"'.$dis.' '.$o_dis.' '); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 input-group"> 
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        <?php echo form_input('end', set_value('end', date(SYS_DATE_FORMAT,$result['end'])), 'id="end" class="form-control datepicker" readonly placeholder="Enter Fiscal Year Ending date"'.$dis.' '.$o_dis.' '); ?>
                                                    ...
                                                    <div class="col-md-9">                                            
                                                        <div class="input-group">
                                                             <label class="switch  switch-small">
                                                                ...
                                                                <?php echo form_checkbox('closed', set_value('closed','1'),$result['closed'], 'id="closed" placeholder=""'.$dis.' '.$o_dis.' '); ?>
                                                                <span></span>
                                                            </label>
                                                         </div>                                            
                                                        <span class="help-block"><?php echo form_error('closed');?>&nbsp;</span>
                                                    </div>
                                                </div> 
                                                 <div class="form-group">
