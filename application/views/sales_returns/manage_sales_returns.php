                            ...
                            <div class="">
                                <div id='add_item_form' class="col-md-12 fl_scrollable_x bg-light-blue-gradient">
                                    ...
                                    <div class="row col-md-12 ">  
                                        ...
                                        <div class="col-md-3">  
                                                <div class="form-group pad">
                                                    <label for="sales_from_date">Purchased from</label>
                                        ...
                                        <div class="col-md-3">  
                                                <div class="form-group pad">
                                                    <label for="sales_invoice_no">Purchased To</label>
                                    ...
                                    <table id="invoice_list_tbl" class="table table-bordered table-striped fl_scrollable">
                                        <thead>
                                           <tr> 
                                               ...
                                               <th width="8%" style="text-align: center;" colspan="2">Qty to Credit</th> 
                                               <th width="8%" style="text-align: center;">price</th> 
                                               <th width="8%" style="text-align: center;">Disc. Refund</th> 
...
function get_inv_items_res(){
        ...
        $.ajax({
                url: "<?php echo site_url('Sales_returns/fl_ajax');?>",
                type: 'post',
                data : post_data,
...
//                                    fl_alert('info',elment.item_quantity)
                                    ...
                                    var newRow = '<tr id="rowb_'+elment.sd_id+'">'+
                                                        '<td style="text-align: center;">'+elment.invoice_no+'<input hidden id="'+elment.sd_id+'_invoice_no" value="'+elment.invoice_no+'"></td>'+
                                                        ...
                                                        '<td style="text-align: center;">'+inv_date+'<input hidden  id="'+elment.sd_id+'_sales_inv_date" value="'+elment.invoice_date+'"></td>'+
                                        ...
                                        if(elment.item_quantity_uom_id_2>0){
                                            newRow +=   '<td style="text-align: left;">'+elment.unit_abbreviation+'<input  step=".001"  max="'+elment.item_quantity+'" type="number" id="'+elment.sd_id+'_unit_to_credit"  value="'+elment.item_quantity+'"><input hidden  id="'+elment.sd_id+'_uom_abr" value="'+elment.unit_abbreviation+'"><input hidden  id="'+elment.sd_id+'_uom_id" value="'+elment.item_quantity_uom_id+'"></td>'+
                                             ...
                                             newRow +=   '<td style="text-align: left;" colspan="2">'+elment.unit_abbreviation+'<br><input   step=".001"  max="'+elment.item_quantity+'" type="number" min="0" max="'+elment.item_quantity_1+'" id="'+elment.sd_id+'_unit_to_credit"  value="'+elment.item_quantity+'"><input hidden  id="'+elment.sd_id+'_uom_abr" value="'+elment.unit_abbreviation+'"><input hidden  id="'+elment.sd_id+'_uom_id" value="'+elment.item_quantity_uom_id+'"></td>';
                                        }
                                            newRow +=  '<td style="text-align: left;">'+elment.currency_code+((parseFloat(elment.discount_persent)>0)?'['+elment.discount_persent+'%]':'')+'<input step="1" type="number" id="'+elment.sd_id+'_unit_price"  value="'+parseFloat(elment.unit_price).toFixed(2)+'"></td>'+
                                                       '<td style="text-align: left;">'+elment.currency_code+'/item<input step="1" type="number" id="'+elment.sd_id+'_disc_amount_item"  value="'+parseFloat(elment.dis_per_item).toFixed(2)+'"></td>'+
                                    ...
                                    $('.add_res_row').click(function(){
                                        ...
                                        var add_id = this.id;
                                        var add_invoice_no = $("#"+add_id+"_invoice_no").val()
                                        var add_invoice_date = $("#"+add_id+"_sales_inv_date").val()
                                        ...
                                        var add_disc_amount_item = $("#"+add_id+"_disc_amount_item").val()
                                        ...
                                        var add_sales_inv_date =  timeConverter($("#"+add_id+"_sales_inv_date").val());
...
//                                       fl_alert('info',add_uom_abr_2)
                                        var add_disc_tot = parseFloat(add_unit_to_credit)* (parseFloat(add_disc_amount_item));
                                        var add_sub_tot = (parseFloat(add_unit_to_credit)* (parseFloat(add_unit_price))) - add_disc_tot;
//                                     
                                        var newRow = '<tr id="rowt_'+add_id+'">'+
                                                        '<td style="text-align: center;">'+add_invoice_no+'<input hidden name="inv_items_btm['+add_id+'][invoice_no]" value="'+add_invoice_no+'"></td>'+
                                                        ...
                                                        '<td style="text-align: center;">'+add_sales_inv_date+'<input hidden name="inv_items_btm['+add_id+'][sales_inv_date]" value="'+add_invoice_date+'"></td>'+
                                                        ...
                                                        '<td style="text-align: right;"><b>'+add_disc_tot.toFixed(2)+'<input hidden name="inv_items_btm['+add_id+'][disc_tot]" id="remove_disctot_'+add_id+'" value="'+add_disc_tot+'"></b></td>'+
