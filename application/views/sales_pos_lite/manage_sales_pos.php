                    ...
                    <div class="box-body">  
                        <div class="row header_form_sales">  
                            ...
                            <table border="0" style="width: 104%;">
                                <tr>
                                    <td width="78%"> 
                                        <?php $this->load->view('sales_pos_lite/pos_layout/left_top_functional_btns'); ?>
                                        <?php $this->load->view('sales_pos_lite/pos_layout/left_item_control'); ?>
                                        
                                    </td>
                                    <td style="padding: 0;padding-left: 5px; font-family: arial; " width=" "> 
                                        <!-- Call  Num pads view-->
                                        <?php $this->load->view('sales_pos_lite/pos_layout/invoice_functions'); ?>
                                        <?php $this->load->view('sales_pos_lite/pos_layout/numpad'); ?>
                                    </td>
                                </tr>
                            </table>  
                            ...
                            <?php $this->load->view('sales_pos_lite/pos_modals_pop'); ?> 
                            <?php echo form_close(); ?>               
...
//                            var all_res1 = JSON.parse(reslt); 
                             $.ajax({
                                    url: "<?php echo site_url('Sales_pos_lite/fl_ajax?function_name=get_single_item');?>",
                                    type: 'post',
                                    data : {function_name:'get_single_item', item_code:$('#item_code').val(), price_type_id:$('#price_type_id').val()},
                                    success: function(result){
...
//                                        console.log(this);
        ...
        function set_temp_invoice(){
            ...
            $.ajax({
                url: "<?php echo site_url('Sales_pos_lite/fl_ajax?function_name=set_temp_invoice');?>",
                type: 'post',
                data : post_data,
                success: function(result){
                        $("#search_result_1").html(result); 
...
//                var total_fin =  $('#invoice_total').val();
            ...
            function get_customers_addons(){ 
                ...
                $('#top_customer_search').attr('title',$("#search_customer_id option:selected").text());
                 $.ajax({
                        url: "<?php echo site_url('Sales_pos_lite/fl_ajax?function_name=get_customer_addons');?>",
                        type: 'post',
...
//                                    return false;
                                    ...
                                    recalculate_totals() 
                                        ...
                                        <?php // $this->load->view('sales_pos_lite/pos_layout/float_keyboard'); ?>