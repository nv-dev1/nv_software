...
<script>
    $(document).ready(function(){
        $('#print_func_btn').click(function(){ 
            ...
            $.ajax({
			url: "<?php echo site_url('Sales_pos_lite/fl_ajax?function_name=pos_print_direct');?>",
			type: 'post',
			data : post_data,
...
//                            set_list_items(result);
        ...
        $('#pick_held_func_btn').click(function(){  
         ...
         function cancel_temp_invoice(){ 
            ...
            $.ajax({
                url: "<?php echo site_url('Sales_pos_lite/fl_ajax?function_name=cancel_temp_invoice');?>",
                type: 'post',
...
//                 return false;
            $.ajax({
                url: "<?php echo site_url('Sales_pos_lite/fl_ajax?function_name=pause_temp_invoice');?>",
                type: 'post',
...
//                    console.log(result)
         ...
         function reserve_temp_invoice(resrv_stat=0){  
            $.ajax({
                url: "<?php echo site_url('Sales_pos_lite/fl_ajax?function_name=reserve_temp_invoice');?>",
                type: 'post',
...
//                                        return false;
                                   $.ajax({
                                       url: "<?php echo site_url('Sales_pos_lite/fl_ajax?function_name=load_temp_invoice');?>",
                                       type: 'post',
