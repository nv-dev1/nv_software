...
$(document).ready(function(){  
	...
	function get_results(){
        $.ajax({
			url: "<?php echo site_url('Quick_entry_accounts/search');?>",
			type: 'post',
 ...
 <br><hr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                ...
                                                <?php echo form_input('ledger_name', set_value('ledger_name'), 'id="ledger_name" class="form-control" placeholder="Search by Reg Number"'); ?>
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">List of Ladger Classes</h3>
            </div>
            <!-- /.box-header -->
