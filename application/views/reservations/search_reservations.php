...
$(document).ready(function(){  
	...
	function get_results(){
        $.ajax({
			url: "<?php echo site_url('Reservations/search');?>",
			type: 'post',
                        ...
                        <div class="row"> 
                            <div class="col-md-6"> 
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Reservation #<span style="color: red"></span></label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <?php echo form_input('res_no', set_value('res_no'), 'id="res_no" class="form-control" placeholder="Search by Resrvation Number"'); ?>

                                            </div>                                            
                                            <span class="help-block"><?php echo form_error('res_no');?></span>
                                        </div>
                                    </div> 
                            </div>  
